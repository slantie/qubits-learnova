...
export function ContactAttendeesModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const data = await api.post(`/courses/${courseId}/contact`, {
        subject,
        body,
      })
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="mx-4 w-full max-w-md rounded-xl bg-background shadow-xl">
            ...
            <>
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  rows={6}
                  disabled={loading}
                  className="w-full resize-none rounded-lg border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:opacity-50"
                />
              </div>
